...
s=pynbody.load("/media/jillian/h329/h329.cosmo50PLK.3072gst5HbwK1BH.000139/h329.cosmo50PLK.3072gst5HbwK1BH.000139")
...
p = pynbody.analysis.profile.Profile(h[2].s,min=.01,max=2,nbins=50,ndim=3,type='log')
...
#finds number of BH
def findBH(s):
     BHfilter = np.where((s.stars['iord']==40810844)|(s.stars['iord']==40811189))
     BH = s.stars[BHfilter]
     return BH
BH = findBH(s)
