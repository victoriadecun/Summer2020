...
s=pynbody.load("/media/jillian/h242/h242.cosmo50PLK.3072gst5HbwK1BH.000096/h242.cosmo50PLK.3072gst5HbwK1BH.000096")
...
pynbody.analysis.angmom.faceon(h0)

#create a profile object for stars in 3D                                                               
p = pynbody.analysis.profile.Profile(h[0].s,min=.01,max=2,nbins=50,ndim=3,type='log')
...
#finds number of BH
def findBH(s):
     BHfilter = np.where((s.stars['iord']==75288952)|(s.stars['iord']==75289338))
     BH = s.stars[BHfilter]
     return BH
BH = findBH(s)
...
with pynbody.analysis.halo.center(h[0], mode='hyb'):
    print (h[0]['pos'][0])
    print (h[0]['pos'][1])
    print (h[0]['pos'][2])
print('pos')
